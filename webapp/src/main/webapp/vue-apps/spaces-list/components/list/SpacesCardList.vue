    ...
    <div
      ...
      <v-card
        ...
        <div class="noSpacesYet">
          ...
          <div
            v-if="displayNoSpaceOptions && $root.canCreateSpace"
            v-html="noSpacesFoundAdminOption"></div>
          <div
            v-else-if="$root.canEdit"
            v-html="noSpacesFoundSettingsOption"></div>
          <div
            v-else
            v-html="$t('spacesList.noSpacesFoundUserOption')"></div>
        </div>
      </v-card>
    </div>
    <div
