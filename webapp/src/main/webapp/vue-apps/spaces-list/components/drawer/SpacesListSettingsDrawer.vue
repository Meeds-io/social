      ...
      <div class="pa-5" flat>
        ...
        <template v-if="settings.filterType === 'template'">
          <v-autocomplete
            ...
            outlined
            dense />
          <div class="mb-2">{{ $t('spacesList.settings.templateListSortTitle') }}</div>
          <v-list class="pa-0" dense>
            <v-list-item
              ...
              <v-list-item-action :class="index == (selectedSpaceTemplates.length - 1) && 'invisible'" class="ms-2 my-auto">
                <v-btn
                  :title="$t('spacesList.settings.moveDown')"
                  icon
                  @click="moveDown(index, settings.templateIds)">
              ...
              <v-list-item-action :class="index == 0 && 'invisible'" class="mx-0 my-auto">
                <v-btn
                  ...
                  icon
                  @click="moveUp(index, settings.templateIds)">
        ...
        <template v-else-if="settings.filterType === 'category'">
          <category-suggester
            v-model="categoryId"
...
export default {
  ...
  computed: {
    ...
    enabledSpaceTemplates() {
      return this.$root.spaceTemplates?.filter?.(t => t.enabled && !t.deleted);
    },
