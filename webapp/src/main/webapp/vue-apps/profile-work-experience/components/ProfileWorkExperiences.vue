<template>
  <v-app
    ...
    <widget-wrapper
      ...
      <div
        v-else-if="displayEmptyBlock"
        v-html="emptyExperiencesOwnerTitle"></div>
    </widget-wrapper> 
    <profile-work-experience-drawer
      ref="profileWorkExperiencesDrawer"
      :experiences="experiences"
      @refresh="setExperiences($event)"
      @refresh-work-experiences-drawer="initWorkExperiencesDrawer" />
  </v-app>
</template>
    ...
    methods: {
      ...
      setExperiences (experiences) {
        ...
        try {
          ...
          console.error('Error sorting experiences', e);  
        }
