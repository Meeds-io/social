  ...
  <v-app class="mx-auto" v-show="this.init">
    <v-hover v-slot="{ hover }">
      <v-card
        ...
        <div v-if="!registerEnabled && !displayForm && signinOption !== 'noform'" class="widget-text-header align-center">{{ $t('portal.login.chooseSignin') }}</div>
...
export default {
  ...
  created() {
    ...
    this.displaySigninEmailButtonIcon = this.values?.displaySigninEmailButtonIcon ? this.values.displaySigninEmailButtonIcon : true;
