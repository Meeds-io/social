...
<template>
  <exo-drawer
    ...
    <template
      ...
      <div
        v-else-if="categoryTree?.owner"
        class="d-flex flex-column align-center justify-center ma-5">
        <v-icon
          color="tertiary"
          size="60">
          fa-th-large
        ...
        <div class="mt-4 mb-2">
          {{ $t('categoryInput.admin.placeholder1') }}
        </div>
        <div
      ...
      <div
        ...
        <div class="mt-4 mb-2">
          {{ $t('categoryInput.user.placeholder1') }}
        </div>
