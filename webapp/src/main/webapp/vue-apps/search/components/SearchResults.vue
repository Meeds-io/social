<template>
  <v-flex>
    ...
    <v-row
      v-if="hasResults"
      class="searchResultsParent justify-center justify-md-start mx-4 border-box-sizing">
      <v-col
    ...
    <v-flex
      v-if="noResults"
      class="searchNoResultsParent d-flex my-auto border-box-sizing">
    ...
    <v-flex
      v-if="hasMore"
      class="searchLoadMoreParent d-flex my-4 border-box-sizing">
      <v-btn
        class="btn mx-auto"
