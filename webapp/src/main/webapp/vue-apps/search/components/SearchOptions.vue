...
-->
<template>
  <div class="searchConnectorsParent d-flex align-center mx-4 mb-4 pb-2 border-box-sizing overflow-x-auto flex-nowrap">
    <v-chip
      :outlined="!favorites"
    ...
    <div v-if="!allEnabled" class="selected-connectors">
      <v-chip
        ...
        :key="connector.name"
        color="primary"
        class="mx-1 border-color flex-shrink-0">
        <v-icon
          v-if="connector.icon"
          size="16"
          class="pe-2">
