...
export default {
  ...
  methods: {
    ...
    getManagedUsers() {
      ...
      this.$userService.getUsersByAdvancedFilter(profileSetting, this.offset, this.limit + 1, 'settings,managedUsersCount', 'all', null, false, this.abortController.signal, 'false').then(data => {
