<template>
  <div
    ...
    <template v-else>
      <v-list-item
        ...
        <div class="flex-grow-1 flex-shrink-1 overflow-hidden">
          ...
          <div
            v-if="hasMoreRepliesToDisplay"
            class="py-0 my-1 align-start d-flex flex-row border-box-sizing">
            <v-btn
    ...
    <div
      v-if="newReplyEditor"
      class="ps-10 py-0 mb-2 align-start border-box-sizing">
      <activity-comment-rich-text
