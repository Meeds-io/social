    ...
    <template #content>
      <v-form
        ...
        <v-card-text class="d-flex userNameLabel flex-grow-1 text-no-wrap pb-2">
          {{ $t('UsersManagement.userName') }}<template v-if="newUser">
            *
          </template>
        </v-card-text>
        ...
        <v-card-text class="d-flex newPasswordLabel flex-grow-1 text-no-wrap pb-2">
          {{ $t('UsersManagement.password') }}<template v-if="newUser">
            *
          </template>
        </v-card-text>
        ...
        <v-card-text class="d-flex confirmPasswordLabel flex-grow-1 text-no-wrap pb-2">
          {{ $t('UsersManagement.confirmPassword') }}<template v-if="newUser">
            *
          </template>
        </v-card-text>
