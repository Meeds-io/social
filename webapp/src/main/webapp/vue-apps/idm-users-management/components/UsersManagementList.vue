      ...
      <template
        ...
        <div
          ...
          <v-badge
            ...
            <template #badge>
              <span><v-icon
                class="successColor mt-n1 me-0"
                size="16">mdi-check-circle</v-icon></span>
            </template>
            <v-icon
              color="primary"
              size="22">
        ...
        <div
          ...
          <v-badge
            ...
            <template #badge>
              <span><v-icon
                class="errorColor mt-n1 me-0"
                size="16">mdi-help-circle</v-icon></span>
            </template>
            <v-btn
              icon
      ...
      <template
        ...
        <span :title="item.isInternal ? $t('UsersManagement.button.editUser') : $t('UsersManagement.tooltip.editSynchronzedUser')">
          <v-btn
            ...
            <i
              class="uiIconEdit"
              :class="!item.isInternal ? 'uiDiseabledIconEdit' : 'uiIconEdit'"></i>
          </v-btn>
        </span>
      </template>
      <template
