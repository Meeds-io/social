            ...
            <nav class="fill-height flex-grow-1">
              <portal-login-introduction :color="hasImage && 'transparent' || 'primary'">
                <template #title>
                  <span
                    class="text-title"
                    :style="`color: ${hasImage && loginBackgroundTextColor || '#ffffff'} !important;`">{{ $t(title) }}</span>
                </template>
                <template #subtitle>
                  <span
                    class="text-body"
                    :style="`color: ${hasImage && loginBackgroundTextColor || '#ffffff'} !important;`">{{ $t(subtitle) }}</span>
                </template>
