...
CKEDITOR.editorConfig = function(config) {
  ...
  const retrieveSpaceRoles = function(query, space) {
    const result = [];
    if (space) {
      if (space.membersCount && (!query?.length || membersLabel.toLowerCase().normalize("NFD").includes(query.normalize("NFD").toLowerCase()))) {
        result.push({
      ...
      if (space.managersCount && (!query?.length || managersLabel.toLowerCase().normalize("NFD").includes(query.normalize("NFD").toLowerCase()))) {
        result.push({
      ...
      if (space.redactorsCount && (!query?.length || redactorsLabel.toLowerCase().normalize("NFD").includes(query.normalize("NFD").toLowerCase()))) {
        result.push({
      ...
      if (space.publishersCount && (!query?.length || publishersLabel.toLowerCase().normalize("NFD").includes(query.normalize("NFD").toLowerCase()))) {
        result.push({
