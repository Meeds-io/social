    ...
    <template #content>
      <v-card class="pa-4" flat>
        ...
        <v-list-item class="px-0" two-line>
          <v-list-item-content>
            <v-list-item-title class="text-font-size text-color">
              <h4 class="my-0">{{ $t('generalSettings.makePublicSiteVisible') }}</h4>
            </v-list-item-title>
        ...
        <v-list-item class="px-0" two-line>
          <v-list-item-content>
            <v-list-item-title class="text-font-size text-color">
              <h4 class="my-0">{{ $t('generalSettings.editPublicSite') }}</h4>
            </v-list-item-title>
            <v-list-item-subtitle class="caption">
...
export default {
  ...
  methods: {
    ...
    copyAddress() {
      try {
        navigator.clipboard.writeText(this.publicSiteLink);
