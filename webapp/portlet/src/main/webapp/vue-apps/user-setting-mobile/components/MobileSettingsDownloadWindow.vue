<template>
    ...
    <span v-if="!isMobile" class="d-flex mx-16 my-6 justify-space-between flex-wrap align-center text-left">
            ...
            <span   >
              ...
              <v-container>
                <v-row align="center">
                    <v-divider></v-divider><span class="grey--text text--lighten-2">{{ $t('MobileSettings.download.or') }}</span><v-divider></v-divider>
                </v-row>
              </v-container>
          </span>
    <span class="d-flex justify-space-between flex-wrap align-center text-left" 
