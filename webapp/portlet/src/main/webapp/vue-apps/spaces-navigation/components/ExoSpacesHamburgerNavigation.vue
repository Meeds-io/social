    ...
    mountSecondLevel(parentId) {
      ...
      if (this.recentSpaces) {
          ...
          methods: {
            ...
            mountThirdLevel(parentId) {
              const VueHamburgerMenuItem = Vue.extend({
                ...
                template: `
                  <exo-space-panel-hamburger-navigation :space="space" :home-link="homeLink" />
                `,
              });
        ...
        VueHamburgerMenuItem = Vue.extend({
          ...
          template: `
            <exo-space-panel-hamburger-navigation :space="space" :home-link="homeLink" @selectHome="selectHome(space)" />
          `,
        });
      }
      new VueHamburgerMenuItem({
