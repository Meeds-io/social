...
if (extensionRegistry) {
  const components = extensionRegistry.loadComponents('SpaceDescriptionApplication');
...
export async function init(spaceId, isManager, publicSiteUrl, spaceDescription) {
