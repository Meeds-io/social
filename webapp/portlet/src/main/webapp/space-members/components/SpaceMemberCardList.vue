<template>
  <v-card flat>
    <v-card-text id="spaceMemberBody" class="pb-0">
      <v-item-group>
            ...
            <div class="ma-auto noPeopleYet">
              ...
              <template v-if="filter === 'connections'">
                <p class="title font-weight-bold">
                  {{ $t('spaceMember.label.noConnection') }}
                </p>
              </template>
              <template v-else-if="hasPeople">
                <p class="title font-weight-bold">
                  {{ $t('spaceMember.label.noResults') }}
                </p>
              </template>
              <template v-else>
                <p class="title font-weight-bold">
                  {{ $t('spaceMember.label.noPeopleYet') }}
                </p>
              </template>
            </div>
          </div>
    ...
    <v-card-actions id="spaceMemberFooter" class="pt-0 px-5 border-box-sizing">
      <v-btn
