  ...
  <v-card :id="userMenuParentId" class="peopleCardItem d-block d-sm-flex" flat>
    ...
    <v-card-actions class="peopleCardActions">
      <exo-confirm-dialog
        ...
        :ok-label="$t('spaceMember.label.ok')"
        :cancel-label="okMethod && $t('spaceMember.label.cancel')"
        @ok="okConfirmDialog"
      ...
      <v-btn
        ...
        <span class="d-none d-sm-inline">
          {{ $t('spaceMember.button.disconnect') }}
        </span>
      ...
      <div v-else-if="user.relationshipStatus === 'INCOMING'" class="invitationButtons">
        <div class="acceptToConnectButtonParent">
          <v-btn
            ...
            <span class="d-none d-sm-flex">
              {{ $t('spaceMember.button.acceptToConnect') }}
            </span>
        ...
        <v-btn
          ...
          <i class="uiIconSocCancelConnectUser d-none d-sm-inline"/>
          <span class="d-none d-sm-flex">
            {{ $t('spaceMember.button.refuseToConnect') }}
          </span>
      ...
      <v-btn
        ...
        <i class="uiIconSocCancelConnectUser d-none d-sm-inline"/>
        <span class="d-none d-sm-inline">
          {{ $t('spaceMember.button.cancelRequest') }}
        </span>
        <v-icon class="d-inline d-sm-none">mdi-close</v-icon>
      </v-btn>
      <v-btn
        ...
        <i class="uiIconSocConnectUser d-none d-sm-inline"/>
        <span class="d-none d-sm-inline">
          {{ skeleton && '&nbsp;' || $t('spaceMember.button.connect') }}
        </span>
  ...
  methods: {
    ...
    disconnectConfirm() {
      this.openConfirmDialog(
        this.$t('spaceMember.title.disconnectConfirm'),
        this.$t('spaceMember.message.disconnectConfirm', {0: `<b>${this.user.fullname}</b>`}),
        this.disconnect);
    },
    acceptToConnect() {
      this.sendingAction = true;
