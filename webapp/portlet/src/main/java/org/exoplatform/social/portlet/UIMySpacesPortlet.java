...
@ComponentConfig(
  ...
  template = "war:/groovy/social/portlet/UIMySpacesPortlet.gtmpl"
)

public class UIMySpacesPortlet extends UIPortletApplication {
  /**
   * constructor
   * @throws Exception
   */
  public UIMySpacesPortlet() throws Exception {
