...
public interface OAuthProviderProcessor<T extends AccessTokenContext> {
   ...
   * {@link org.gatein.security.oauth.spi.InteractionState} is in state
   * {@link org.gatein.security.oauth.spi.InteractionState.State#FINISH} and in
   * this case, InteractionState should also have accessToken filled. If
   * {@link org.gatein.security.oauth.spi.InteractionState} is in state
   * {@link org.gatein.security.oauth.spi.InteractionState.State#AUTH}, then
   ...
   *                          least
   *                          {@link org.gatein.security.oauth.exception.OAuthExceptionCode#USER_DENIED_SCOPE}
   ...
   *                          {@link org.gatein.security.oauth.exception.OAuthExceptionCode#TOKEN_REVOCATION_FAILED}
   ...
   *                          {@link org.gatein.security.oauth.exception.OAuthExceptionCode#ACCESS_TOKEN_ERROR}
   *                          if invalid access is used as argument -
   *                          {@link org.gatein.security.oauth.exception.OAuthExceptionCode#IO_ERROR}
   *                          if IO error occurs
   */
