...
import org.exoplatform.social.metadata.AttachementPermissionPlugin;

public class ActivityAttachementPermissionPlugin extends AttachementPermissionPlugin {

  private static final String   ACTIVITY_ATTACHEMENT_TYPE = "activity";

  private final ActivityManager activityManager;

  public ActivityAttachementPermissionPlugin(ActivityManager activityManager) {
