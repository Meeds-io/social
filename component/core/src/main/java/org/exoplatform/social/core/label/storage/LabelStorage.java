...
package org.exoplatform.social.core.label.storage;
...
public class LabelStorage {
  ...
  public LabelStorage(LabelDAO labelDAO) {
  ...
  public List<Label> findLabelByObjectTypeAndObjectId(String objectType, String objectId) {
    return labelDAO.findLabelByObjectTypeAndObjectId(objectType, objectId).stream().map(this::convertFromEntity).toList();
  }
