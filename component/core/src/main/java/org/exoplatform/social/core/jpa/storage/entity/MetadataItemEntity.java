...
@NamedNativeQuery(
    name = "SocMetadataItemEntity.countMetadataItemsByMetadataTypeAndSpaceId",
    query = "SELECT item.space_id, COUNT(DISTINCT item.metadata_item_id) FROM SOC_METADATA_ITEMS item "
