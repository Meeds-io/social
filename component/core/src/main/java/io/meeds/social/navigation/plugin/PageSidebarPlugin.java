...
@Component
@Order(20)
public class PageSidebarPlugin extends AbstractLayoutSidebarPlugin {
  ...
  public SidebarItem resolveProperties(SidebarItem item, String username, Locale locale) {
    return resolvePageItemProperties(item, locale);
  }
  ...
  public boolean itemExists(SidebarItem item, String username) {
    ...
    return isEligiblePage(Long.parseLong(nodeIdProperty), username);
  }
