...
@Component
public class CategoryTranslationImportService {

  private static final Log            LOG                  = ExoLogger.getLogger(CategoryTranslationImportService.class);
  ...
  public void saveTranslationLabels(String objectType, long objectId, String fieldName, Map<String, String> labels) {
