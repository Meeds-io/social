...
/**
 * What happens on the activity streams the user follows: posts, comments,
 * mentions and likes.
 */
@Component
public class FeedDigestCategoryProvider implements DigestCategoryProvider {
  ...
  public List<String> getPluginIds() {
    return List.of("PostActivityPlugin",
