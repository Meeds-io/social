...
public class BaseUIActivity extends UIForm {
  ...
  public boolean isActivityDeletable() throws SpaceException {
    ...
    if (space != null) {
      return userACL.isSuperUser() || spaceService.isManager(space, Utils.getOwnerRemoteId()) || ConversationState.getCurrent().getIdentity().getGroups().contains(userACL.getAdminGroups());
    }
