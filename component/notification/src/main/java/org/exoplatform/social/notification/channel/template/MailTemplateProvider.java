...
public class MailTemplateProvider extends TemplateProvider {
  ...
  protected MessageInfo makeMessage(NotificationContext notificationContext) {
    ...
    templateContext.put("FIRST_NAME", encoder.encode(inviterIdentity.getProfile().getProperty(Profile.FIRST_NAME).toString()));
    ...
    templateContext.put("FOOTER_LINK", LinkProviderUtils.getRedirectUrl("notification_settings", inviterIdentity.getRemoteId()));
