...
public class SpaceRest implements ResourceContainer {
  ...
  @RolesAllowed("users")
  @Operation(summary = "Gets spaces by a list of ids", method = "GET", description = "Returns accessible spaces matching the provided ids")
  @ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Request fulfilled"),
      @ApiResponse(responseCode = "400", description = "Invalid query input") })
  public Response getSpacesByIds(@Context
                                 UriInfo uriInfo,
    ...
    List<Space> spaces = ids.stream()
                            ...
                            .filter(space -> spaceService.canListSpace(space, authenticatedUser))
                            .toList();
    CollectionEntity collectionSpace = EntityBuilder.buildEntityFromSpaces(spaces,
                                                                           authenticatedUser,
                                                                           0,
