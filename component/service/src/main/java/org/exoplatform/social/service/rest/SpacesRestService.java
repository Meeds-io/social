...
public class SpacesRestService implements ResourceContainer {
   ...
   * @deprecated Deprecated from 4.3.x. Replaced by a new API {@link SpaceRestResourcesV1#getSpaces(UriInfo, Request, String, int, int, String, String, boolean, boolean, String)}
   */
  @GET
  @RolesAllowed("users")
  @Path("suggest.{format}")
